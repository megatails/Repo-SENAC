    ...
    if ($_SERVER['REQUEST_METHOD'] === 'PUT') {
        try {
            ...
            if ($pizza->update()) {
                ...
                echo json_encode(array('Mensagem' => 'Pizza Atualizada com Sucesso'));
            } else {
                http_response_code(500);
                echo json_encode(array('Mensagem' => 'Nao foi possivel atualizar a Pizza'));
            }
            } else {
                http_response_code(400);
                echo json_encode(array('Mensagem' => 'Dados Incompletos. Nao foi possivel atualizar a Pizza.'));
            }
        } catch (Exception $e) {        
