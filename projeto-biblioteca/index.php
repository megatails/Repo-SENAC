...
<body>
    ...
    <div class="conteudo"><br><br><br>
        ...
        <img style="border-radius: 12px" width="50%" src="https://www.institutefordigitaltransformation.org/wp-content/uploads/Digital-Library-scaled.jpeg" alt="uma mão alimentando livres à um tablet">
    </div>
