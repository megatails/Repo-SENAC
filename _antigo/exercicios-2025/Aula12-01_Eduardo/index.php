...
<body>
    <div class='multi'>
        ...
        <input class="botao" type="submit" value="Exercicio 01">
        </form>

        <form action="exercicio02.php" method="post">
        <input class="botao" type="submit" value="Exercicio 02">
        </form>
    ...
    <div class='multi'>
        ...
        <input class="botao" type="submit" value="Exercicio 11">
        </form>
    ...
    <div class='multi'>
        ...
        <input class="botao" type="submit" value="Exercicio 14">
        </form>
